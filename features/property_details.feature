Feature: 99acres property details functionality
  As a user
  I want to open a property details page
  So that I can review the listing

  Scenario: Open a filtered property details page
